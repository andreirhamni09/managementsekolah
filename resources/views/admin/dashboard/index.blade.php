          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="" class="nav-link">
                ...
                <p class="brand-text" style="color:white;">Daftar Siswa</p>
              </a>
            </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-4 mx-auto">
              <div class="card mx-auto" style="width:80%; border:4px solid black;">
                <div class="card-header" style="border-bottom:3px solid black;text-align:center;">
                  <h3 style="color:#9C9EA1;">Daftar Siswa/h3>
                </div>
            ...
            <div class="col-md-4 mx-auto">
              <div class="card mx-auto" style="width:80%; border:4px solid black;">
                <div class="card-header" style="border-bottom:3px solid black;text-align:center;">
                  <h3 style="color:#9C9EA1;">Pendaftar Baru</h3>
                </div>
                <div class="card-body" style="border-bottom:3px solid black;text-align:center; background-color: #06B8FF;">
                  <i class="nav-icon fas fa-user-edit fa-5x" style="color:black;"></i>
                </div>
                <div class="card-footer">
                  <a href="" class="btn btn-secondary float-sm-right">Lihat</a>
                </div>
            ...
            <div class="col-md-4 mx-auto">
              <div class="card mx-auto" style="width:80%; border:4px solid black;">
                <div class="card-header" style="border-bottom:3px solid black;text-align:center;">
                  <h3 style="color:#9C9EA1;">Dosen</h3>
                </div>
                <div class="card-body" style="border-bottom:3px solid black;text-align:center; background-color: #06B8FF;">
            ...
            <div class="col-md-4 mr-auto">
              <div class="card mx-auto" style="width:80%; border:4px solid black;">
                <div class="card-header" style="border-bottom:3px solid black; text-align:center;">
                  <h3 style="color:#9C9EA1;">Kalender Perkuliahan</h3>
                </div>
                <div class="card-body" style="border-bottom:3px solid black;text-align:center; background-color: #06B8FF;">
                  <i class="nav-icon fas fa-calendar-alt fa-5x" style="color:black;"></i>
                </div>
            ...
            <div class="col-md-4 mr-auto">
              <div class="card mx-auto" style="width:80%; border:4px solid black;">
                <div class="card-header" style="border-bottom:3px solid black; text-align:center;">
                  <h3 style="color:#9C9EA1;">Jurusan</h3>
                </div>
                <div class="card-body" style="border-bottom:3px solid black;text-align:center; background-color: #06B8FF;">
                  <i class="nav-icon fas fa-book fa-5x" style="color:black;"></i>
                </div>
                <div class="card-footer">
                  <a href="{{ url('/sertifikat') }}" class="btn btn-secondary float-sm-right">Lihat</a>
                </div>
            ...
            <div class="col-md-4 mr-auto">
              <div class="card mx-auto" style="width:80%; border:4px solid black;">
                <div class="card-header" style="border-bottom:3px solid black; text-align:center;">
                  <h3 style="color:#9C9EA1;">Alumni</h3>
                </div>
                <div class="card-body" style="border-bottom:3px solid black;text-align:center; background-color: #06B8FF;">
                  <i class="nav-icon fas fa-user-graduate fa-5x" style="color:black;"></i>
                </div>
                <div class="card-footer">
                  <a href="{{ url('/sertifikat') }}" class="btn btn-secondary float-sm-right">Lihat</a>
                </div>
