...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-10 mx-auto">
                            <div class="card" style="border:4px solid black;">
                                <div class="card-header" style="border-bottom:3px solid black;">
                                    <h3 style="color:#9C9EA1; font-size: 16pt; font-weight: bold;" class="card-title">Daftar Sertifikat</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mx-auto">
                                            <div class="card mx-auto" style="width:80%; border:4px solid black;">
                                                <div class="card-header" style="text-align: center; border-bottom:4px solid black;">
                                                    <h5 class="text-title">Table Manner</h5>
                                                </div>
                                                <div class="card-body" style="background-color: #06B8FF; border-bottom:4px solid black;">
                                                    <img src="{{ asset('public/img/Logo GEC.png') }}" class="img-fluid img-thumbnail">
                                                </div>
                                                <div class="card-footer">
                                                    <button type="submit" class="btn btn-success float-sm-right ml-2">Download</button>
                                                    <button type="submit" class="btn btn-primary float-sm-right">Lihat</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mx-auto">
    ...
    <script src="{{ asset('public/pluginsdatatables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('public/pluginsdatatables-bs4/js/dataTables.bootstrap4.min.js') }}"></script>
    <script src="{{ asset('public/pluginsdatatables-responsive/js/dataTables.responsive.min.js') }}"></script>
    <script src="{{ asset('public/pluginsdatatables-responsive/js/responsive.bootstrap4.min.js') }}"></script>
